...
function createAlexaAccountLinkReply() {
  var reply = {
    ...
    "response": {
      "outputSpeech": {
        "type": "PlainText",
        "text": "You must have a Hitachi Consulting account to access Autobot. Please use the Alexa app to link your Amazon account with your Hitachi Consulting account."
      },
      "card": {
        "type": "LinkAccount"
      },
