...
function createAlexaSessionEndReply() {
  var reply = {
    ...
    "response": {
      "outputSpeech": {
        "type": "PlainText",
        "text": "Thank you for using sumo san"
      },
...
function createAlexaAccountLinkReply() {
  var reply = {
    "version": "1.0",
    "response": {
      "outputSpeech": {
        "type": "PlainText",
        "text": "You must have a Hitachi Consulting account to access Sumo san. Please use the Alexa app to link your Amazon account with your Hitachi Consulting account."
      },
      "card": {
        "type": "LinkAccount"
      },
...
function alexaSays(req, res, bot, next) {
  ...
  if (!req.body.session.user.accessToken){
    var reply = createAlexaAccountLinkReply();
    res.send(reply);
    next();
  }
